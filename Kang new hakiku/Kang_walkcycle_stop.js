...
// stage content:
(lib.Kang_walkcycle_stop = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.redHead_mc.setTransform(487.65,414.05,0.35,0.35,0,0,0,-21,-127.5);

	this.instance = new lib.walking();
	this.instance.setTransform(1195.95,362.45,1,1,0,0,0,-21,-127.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance},{t:this.redHead_mc}]}).wait(1));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(917.9,436.7,420.4,171.59999999999997);
// library properties:
lib.properties = {
