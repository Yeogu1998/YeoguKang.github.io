...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(2).to({y:-218.95},0).wait(2).to({y:-230.95},0).wait(2).to({y:-235.95},0).wait(2));
...
// stage content:
(lib.Yeogu_walkcycle = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance.setTransform(225.05,362.45,0.35,0.35,0,0,0,-21,-127.5);

	this.instance_1 = new lib.walking();
	this.instance_1.setTransform(1195.95,362.45,1,1,0,0,0,-21,-127.5);
...
p.nominalBounds = new cjs.Rectangle(655.3,436.7,683,171.59999999999997);
// library properties:
lib.properties = {
	id: '3C35F2383BB71548844F87981FB0B012',
	width: 960,
	height: 640,
	fps: 24,
	color: "#FFFFFF",
...
an.compositions['3C35F2383BB71548844F87981FB0B012'] = {
